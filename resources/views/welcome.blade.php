...
@section('content')
    <section
        class="rounded-lg bg-white dark:bg-[#161615] dark:text-[#EDEDEC] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d] p-6 lg:p-12">
        <div class="max-w-3xl">
            ...
            <p class="mt-2 text-[#706f6c] dark:text-[#A1A09A]">
                ...
                existing system will remain active while
                we progressively move features and data across.
            </p>
        </div>
        ...
        <div class="mt-8 grid grid-cols-1 gap-4 lg:grid-cols-2">
            <div class="rounded-md p-5 border border-[#e3e3e0] dark:border-[#3E3E3A] bg-[#FDFDFC] dark:bg-[#0f0f0e]">
                ...
                <div class="mt-4">
                    <a href="https://chat.whatsapp.com/HkGHDBHyVap6yC8gGLXCHC" target="_blank"
                       class="inline-block px-4 py-2 rounded-sm bg-[#1b1b18] text-white border border-black hover:bg-black dark:bg-[#eeeeec] dark:text-[#1C1C1A] dark:border-[#eeeeec] dark:hover:bg-white">
            ...
            <div class="rounded-md p-5 border border-[#e3e3e0] dark:border-[#3E3E3A] bg-[#FDFDFC] dark:bg-[#0f0f0e]">
                <h2 class="font-semibold text-lg">Support Financially</h2>
                <p class="mt-2 text-[#706f6c] dark:text-[#A1A09A]">
                ...
                <div class="mt-4">
                    <a href="https://www.scoutfoundation.org.za/donate/#monthly-donation-options" target="_blank"
                       class="inline-block px-4 py-2 rounded-sm bg-[#f53003] text-white border border-[#f53003] hover:bg-[#ca2800] dark:bg-[#FF4433] dark:border-[#FF4433]">
                        Donate to Scouts South Africa
                    </a>
                </div>
            </div>
        </div>
        ...
        <div
            class="mt-8 border-t border-[#e3e3e0] dark:border-[#3E3E3A] pt-6 text-[13px] leading-5 text-[#706f6c] dark:text-[#A1A09A] text-center">
            <p>
                Want to follow progress?
            </p>
            <p>
                Keep an eye on our <a
                    href="https://chat.whatsapp.com/HkGHDBHyVap6yC8gGLXCHC"
                    target="_blank"
                    class="text-[#F53003] dark:text-[#FF4433] hover:underline underline-offset-4">official
                    WhatsApp Community</a>.
            </p>
            <p>
                We'll share milestones as we deliver new modules and migrate data.
            </p>
        </div>
    </section>
@endsection
