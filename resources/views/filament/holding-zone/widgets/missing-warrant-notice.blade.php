...
<x-filament-widgets::widget>
    <div class="rounded-xl border border-danger-300 bg-danger-50 p-4 dark:border-danger-600 dark:bg-danger-950/50">
        <div class="flex gap-3">
            <x-heroicon-o-shield-exclamation class="mt-0.5 size-5 shrink-0 text-danger-500" />
            <div>
                <h3 class="font-medium text-danger-800 dark:text-danger-200">Missing Warrant</h3>
                <p class="mt-1 text-sm text-danger-700 dark:text-danger-300">
                    The following role(s) require a valid warrant before you can access them. Please contact your next in line Scouter to have your warrant issued or renewed.
                </p>
