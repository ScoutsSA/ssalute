...
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-1640-2360.jpg') }}" media="(device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2360-1640.jpg') }}" media="(device-width: 820px) and (device-height: 1180px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)">
...
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-1488-2266.jpg') }}" media="(device-width: 744px) and (device-height: 1133px) and (-webkit-device-pixel-ratio: 2) and (orientation: portrait)">
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2266-1488.jpg') }}" media="(device-width: 744px) and (device-height: 1133px) and (-webkit-device-pixel-ratio: 2) and (orientation: landscape)">
...
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2868-1320.jpg') }}" media="(device-width: 440px) and (device-height: 956px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)">
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-1206-2622.jpg') }}" media="(device-width: 402px) and (device-height: 874px) and (-webkit-device-pixel-ratio: 3) and (orientation: portrait)">
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2622-1206.jpg') }}" media="(device-width: 402px) and (device-height: 874px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)">
...
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2796-1290.jpg') }}" media="(device-width: 430px) and (device-height: 932px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)">
...
<link rel="apple-touch-startup-image" href="{{ asset('icons/apple-splash-2556-1179.jpg') }}" media="(device-width: 393px) and (device-height: 852px) and (-webkit-device-pixel-ratio: 3) and (orientation: landscape)">
