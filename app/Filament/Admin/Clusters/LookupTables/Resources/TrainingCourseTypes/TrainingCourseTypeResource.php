...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\TrainingCourseTypes;

use App\Filament\Admin\Clusters\LookupTables\LookupTablesCluster;
use App\Filament\Admin\Clusters\LookupTables\Resources\TrainingCourseTypes\Pages\ManageTrainingCourseTypes;
...
class TrainingCourseTypeResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: none found; nothing in the legacy app reads this table. Ssalute offers it as the optional course type on the Training Courses page. Removal candidate if that stays unused, see ticket 005.')
            ->columns([
