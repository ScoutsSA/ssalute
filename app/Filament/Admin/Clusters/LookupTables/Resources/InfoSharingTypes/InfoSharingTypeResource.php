...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\InfoSharingTypes;
...
class InfoSharingTypeResource extends Resource
{
    protected static ?string $model = InfoSharingType::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::FolderOpen;

    protected static ?string $pluralLabel = 'Info Sharing Types';
    ...
    {
        return [
            'index' => ManageInfoSharingTypes::route('/'),
        ];
    }
}
