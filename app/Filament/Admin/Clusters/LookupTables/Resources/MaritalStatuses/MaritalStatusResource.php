...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\MaritalStatuses;

use App\Filament\Admin\Clusters\LookupTables\LookupTablesCluster;
use App\Filament\Admin\Clusters\LookupTables\Resources\MaritalStatuses\Pages\ManageMaritalStatuses;
...
class MaritalStatusResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: the marital status options on the AMS adult add and edit forms.')
            ->columns([
