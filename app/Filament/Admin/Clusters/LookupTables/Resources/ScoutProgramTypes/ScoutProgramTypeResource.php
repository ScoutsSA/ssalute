...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\ScoutProgramTypes;
...
class ScoutProgramTypeResource extends Resource
{
    protected static ?string $model = SystemProgramTypesScout::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::CalendarDays;

    protected static ?string $pluralLabel = 'Scout Program Types';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: program and meeting types for the Scout branch, used when adding or editing programs and events, on advancement and badge sign off from programs, and on census and group reports.')
            ->columns([
    ...
    {
        return [
            'index' => ManageScoutProgramTypes::route('/'),
        ];
    }
}
