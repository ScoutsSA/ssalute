...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\RoverLevels;

use App\Filament\Admin\Clusters\LookupTables\LookupTablesCluster;
use App\Filament\Admin\Clusters\LookupTables\Resources\RoverLevels\Pages\ManageRoverLevels;
...
class RoverLevelResource extends Resource
{
    ...
    protected static ?string $pluralLabel = 'Rover Levels';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: the Rover advancement levels, used across advancement sign off from programs and events, admin advancement screens, youth advancement reports and the crew dashboard.')
            ->columns([
