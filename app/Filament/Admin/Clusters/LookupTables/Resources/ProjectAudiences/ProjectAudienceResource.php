...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\ProjectAudiences;
...
class ProjectAudienceResource extends Resource
{
    protected static ?string $model = ProjectsFor::class;

    protected static string|BackedEnum|null $navigationIcon = Heroicon::Heart;

    protected static ?string $pluralLabel = 'Project Audiences';
    ...
    {
        return [
            'index' => ManageProjectAudiences::route('/'),
        ];
    }
}
