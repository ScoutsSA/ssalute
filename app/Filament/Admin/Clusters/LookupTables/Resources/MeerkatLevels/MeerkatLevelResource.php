...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\MeerkatLevels;

use App\Filament\Admin\Clusters\LookupTables\LookupTablesCluster;
use App\Filament\Admin\Clusters\LookupTables\Resources\MeerkatLevels\Pages\ManageMeerkatLevels;
...
class MeerkatLevelResource extends Resource
{
    ...
    protected static ?string $pluralLabel = 'Meerkat Levels';
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: the Meerkat advancement levels, used across advancement sign off from programs and events, admin advancement screens, youth advancement reports and dashboards.')
            ->columns([
    ...
    {
        return [
            'index' => ManageMeerkatLevels::route('/'),
        ];
    }
}
