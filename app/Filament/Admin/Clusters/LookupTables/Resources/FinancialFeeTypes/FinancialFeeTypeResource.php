...
namespace App\Filament\Admin\Clusters\LookupTables\Resources\FinancialFeeTypes;

use App\Filament\Admin\Clusters\LookupTables\LookupTablesCluster;
use App\Filament\Admin\Clusters\LookupTables\Resources\FinancialFeeTypes\Pages\ManageFinancialFeeTypes;
...
class FinancialFeeTypeResource extends Resource
{
    ...
    public static function table(Table $table): Table
    {
        return $table
            ...
            ->description('Database table: ' . app(static::getModel())->getTable() . '. Legacy usage: none found. The legacy app reads the per group group_financial_fee_types table instead, and nothing in Ssalute reads this table either. Removal candidate, see ticket 005.')
            ->columns([
