                ...
                Section::make('Advancement Details')
                    ...
                    ->schema([
                        ...
                        Select::make('advancementID')
                            ...
                            ->options(fn () => SystemAdvancementScoutsLevel::query()->orderBy('position')->pluck('name', 'id'))
                            ->searchable(),
                        Select::make('themeID')
                            ->label('Challenge Theme')
                            ->options(fn () => SystemAdvancementScoutsSecondEntshaTheme::query()->orderBy('themeName')->pluck('themeName', 'id'))
                            ->searchable(),
