...
class AamRequestForm extends Component implements HasSchemas
{
    ...
    {
        return view('forms.aam.aam_request_form')
            ->layoutData([
                'title' => 'AAM - Ssalute',
            ]);
    }
    ...
    public function mount(Request $request, FormSettings $formSettings): void
    {
        ...
        /*$this->form->fill([
            ...
            'id_document' => 'JcHCu7v1qm709dKjBP4mvfeCV2IXem-metaU2VsZWN0aW9uXzAwMS5wbmc=-.png',
            'criminal_record => 'JcHCu7v1qm709dKjBP4mvfeCV2IXem-metaU2VsZWN0aW9uXzAwMS5wbmc=-.png',
...
<li>17. I have watched the <a class='font-medium text-blue-600 underline dark:text-blue-500 hover:no-underline' href='https://www.youtube.com/watch?v=5lNyx8JmZK8'>WOSM introductory Safe from Harm video</a>. See more: https://www.scout.org/safefromharm</li></ol>")),
    ...
    public function create(): void
    {
        ...
        $aamRequest = ApplicationAdultMembershipRequest::create([
            ...
            'id_document' => $state['id_document'] ?? null,
            'criminal_record' => $state['criminal_record'] ?? null,
